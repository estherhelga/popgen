...
pca_eigenvectors <- read.table("final_pca_results_no_outliers.eigenvec", header = FALSE, as.is = TRUE)
...
pca_eigenvalues <- read.table("final_pca_results_no_outliers.eigenval", header = FALSE)
