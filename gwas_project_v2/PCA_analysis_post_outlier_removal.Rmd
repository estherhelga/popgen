...
pca_eigenvectors <- read.table("gwas_core_1124_pca_20pcs.eigenvec", header = FALSE, as.is = TRUE)
...
pca_eigenvalues <- read.table("gwas_core_1124_pca_20pcs.eigenval", header = FALSE)
...
pca_eigenvalues$PC_num <- seq_len(nrow(pca_eigenvalues))        # b add this back
...
output_dir <- "pca_plots_no_omniexpress_no_outliers"  # Set your desired output folder
