...
sexcheck_data <- read.table("sex_check_results.sexcheck", header = TRUE, as.is = TRUE)
...
if (nrow(samples_to_remove_df) > 0) {
  write.table(samples_to_remove_df, "individuals_to_remove_sex_issues.txt", 
              col.names = FALSE, row.names = FALSE, quote = FALSE, sep = "\t")
  cat("Written", nrow(samples_to_remove_df), "samples to individuals_to_remove_sex_issues.txt\n")
} else {
