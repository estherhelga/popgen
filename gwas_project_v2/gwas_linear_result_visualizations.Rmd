...
gwas_results_file <- "gwas_eyecolor_linear_correct_20pcs_sex.assoc.linear"
gwas_data <- read.table(gwas_results_file, header = TRUE, stringsAsFactors = FALSE)
...
png("gwas_qqplot.png", width = 6, height = 6, units = "in", res = 300) # Save plot
...
dev.off()
print("QQ plot saved as gwas_qqplot.png")
...
png("gwas_manhattan_plot.png", width = 12, height = 6, units = "in", res = 300) # Save plot
...
dev.off()
print("Manhattan plot saved as gwas_manhattan_plot.png")
