...
fam_file_of_gwas_cohort <- "gwas_core_1124.fam"
...
pheno_box_plot <- ggplot(merged_data_top_snp_clean, aes(x = GenotypeFactor, y = EYE_COLOR_SCORE, fill = GenotypeFactor)) +
  geom_boxplot(alpha=0.7, outlier.shape = NA) + # Hide outliers from boxplot itself
  geom_jitter(width = 0.2, alpha = 0.4, height = 0.1, size=1.5) + # Show individual points with some jitter
...
ggsave(paste0("pheno_boxplot_by_genotype_", TOP_SNP_ID, ".png"), plot = pheno_box_plot, width = 7, height = 6, dpi = 300)
