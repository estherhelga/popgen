...
pca_eigenvalues <- read.table("final_pca_results.eigenval", header = FALSE, as.is = TRUE)
colnames(pca_eigenvalues) <- "Eigenvalue"
pca_eigenvalues$PC_num <- 1:nrow(pca_eigenvalues)
pca_eigenvalues$VarianceExplained <- pca_eigenvalues$Eigenvalue / sum(pca_eigenvalues$Eigenvalue) * 100
...
print(head(pca_eigenvalues[,c("PC_num", "VarianceExplained")]), 10)
cat("\n\n")
